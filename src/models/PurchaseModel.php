...
class PurchaseModel extends Model {
     ...
     */
    public function addPurchaseItem($purchaseId, $productId, $quantity, $price) {
        $this->db->query("INSERT INTO PurchaseItem (PurchaseNo, ProductNo, Quantity, Price, Subtotal) 
                          VALUES (:purchaseId, :productId, :quantity, :price, :subtotal)");
