...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="<?php echo BASE_URL; ?>/admin/index.php?page=products" class="card-link">
            <div class="dashboard-card" data-href="<?php echo BASE_URL; ?>/admin/index.php?page=products">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="<?php echo BASE_URL; ?>/admin/index.php?page=orders" class="card-link">
            <div class="dashboard-card" data-href="<?php echo BASE_URL; ?>/admin/index.php?page=orders">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="<?php echo BASE_URL; ?>/admin/index.php?page=customers" class="card-link">
            <div class="dashboard-card" data-href="<?php echo BASE_URL; ?>/admin/index.php?page=customers">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="<?php echo BASE_URL; ?>/admin/index.php?page=testimonials" class="card-link">
            <div class="dashboard-card" data-href="<?php echo BASE_URL; ?>/admin/index.php?page=testimonials">
...
<div class="row mt-4">
    <div class="col-12">
        <?php include ROOT_DIR . '/src/views/admin/pages/widgets/email-status.php'; ?>
    </div>
</div>
