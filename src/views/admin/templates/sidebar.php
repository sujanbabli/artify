...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="dashboard-card">
            ...
            <!-- No link for customers page yet -->
        </div>
    </div>
...
<!-- Products -->
<li class="nav-item">
    <a class="nav-link <?php echo ($page === 'products' || $page === 'product-form' || $page === 'product-detail') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/index.php?page=products">
...
<!-- Orders -->
<li class="nav-item">
    <a class="nav-link <?php echo ($page === 'orders' || $page === 'order-detail') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/index.php?page=orders">
...
<!-- Testimonials -->
<li class="nav-item">
    <a class="nav-link <?php echo ($page === 'testimonials' || $page === 'testimonial-detail') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/index.php?page=testimonials">
...
<!-- News -->
<li class="nav-item">
    <a class="nav-link <?php echo ($page === 'news' || $page === 'news-form' || $page === 'news-detail') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/index.php?page=news">
...
<!-- Settings -->
<li class="nav-item">
    <a class="nav-link <?php echo ($page === 'settings') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/index.php?page=settings">
